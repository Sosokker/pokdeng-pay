...
const en: TranslationDict = {
	...
	"auth.googleNote":
		"Sign in with Google to save your game history across devices",
	"auth.guestNote": "Guest games are not saved to history",
	"auth.guestLabel": "Guest",
	"auth.signInForHistory": "Sign in for history",
	"auth.switchName": "Switch name",
	...
	"history.subtitle": "View your past game sessions and results",
	"history.empty": "No game history yet. Complete a game to see it here.",
	"history.signInRequired":
		"Sign in with Google to save and view your game history across devices.",
...
const th: TranslationDict = {
	...
	"auth.googleNote": "ลงชื่อเข้าใช้ด้วย Google เพื่อบันทึกประวัติเกมข้ามอุปกรณ์",
	"auth.guestNote": "เกมแบบแขกจะไม่ถูกบันทึกในประวัติ",
	"auth.guestLabel": "แขก",
	"auth.signInForHistory": "ลงชื่อเข้าใช้เพื่อดูประวัติ",
	"auth.switchName": "เปลี่ยนชื่อ",
	...
	"history.subtitle": "ดูประวัติเซสชันเกมที่ผ่านมา",
	"history.empty": "ยังไม่มีประวัติเกม เล่นจบเซสชันจะถูกบันทึกที่นี่",
	"history.signInRequired": "ลงชื่อเข้าใช้ด้วย Google เพื่อบันทึกและดูประวัติเกมข้ามอุปกรณ์",
